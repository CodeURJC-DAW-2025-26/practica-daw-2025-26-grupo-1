...
import es.codeurjc.daw.museum.dto.ErrorDTO;
...
public class ErrorRestController implements ErrorController {
    ...
    public ResponseEntity<ErrorDTO> handleResponseStatusException(org.springframework.web.server.ResponseStatusException ex) {
