...
public class DataInitializer {
        ...
        public void init() throws IOException, URISyntaxException {
                ...
                if (objectService.findAll().isEmpty()) {
                        ...
                        tetraNeon.setObjectName("Tetra Neon");
                        ...
                        tetraNeon.setDescription(
                                        "El tetra neon es una especie de pez ornamental muy popular en jardines y estanques.");
                        ...
                        libelulaTigre.setObjectName("Libelula tigre");
                        libelulaTigre.setGroupName("Libelula tigre");
                        libelulaTigre.setType("insectos");
                        libelulaTigre.setCategory("Aéreos");
                        libelulaTigre.setTechnicalData(
                                        "Tamaño: 8-10 cm. Peso: 0.5-1.5 g. Hábitat: bosques y praderas.");
                        libelulaTigre.setDescription(
                                        "La libelula tigre es un insecto volador conocido por su apariencia similar a una tigre y su comportamiento depredador.");
                        ...
                        dientesDeSable.setObjectName("Dientes de Sable");
                        ...
                        dientesDeSable.setDescription(
                                        "Los dientes de sable son fósiles de animales prehistóricos conocidos por su tamaño y forma distinctive.");
